...
class MoveCommand:
    ...
    def move_batch(self, d: CrateStacks):
        element_to_move = d[self._from][-self._quantity:]
        d[self._to].extend(element_to_move)
        d[self._from] = d[self._from][:len(d[self._from]) - self._quantity]
